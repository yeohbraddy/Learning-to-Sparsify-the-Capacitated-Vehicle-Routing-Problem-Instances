...
AVERAGE_NODE_DEMAND_CAPACITY_RATIO = "AVERAGE_NODE_DEMAND_CAPACITY_RATIO"
...
column_names = [
    ...
    NODE_U_DIST_TO_NEAREST_NEIGHBOUR,
    NODE_V_DIST_TO_NEAREST_NEIGHBOUR,
    NODE_AVERAGE_DIST_TO_NEAREST_NEIGHBOUR,
